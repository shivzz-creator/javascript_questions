...
// // A: It's not a string! 
// // B: Yay it's a string! * ( because number is a true value)
// // C: TypeError
// // D: undefined
...
// A: 2 4 and 3 6  * default parameter
// B: 2 NaN and 3 NaN
// C: 2 Error and 3 6
// D: 2 4 and 3 Error
...
// C: person.address.street = "101 Main St" * this is a property of address
...
// Object.seal(person);
// A: person.name = "Evan Bacon" * can only change
// B: person.age = 21
...
// B: false
// C: undefined
// D: TypeError * trying to access undefined object
...
// B: [1, 2, 3, 5]
// C: [1, 2, 3, 4]
// D: Error  * since newList is a variable
...
// C: ReferenceError  * (variable not defined)
// D: undefined
